...
public:
   ...
   {
      dofs_vector_out = 0.0;
      auto dofs_in = MakeReadOnlyElementVectorView< TrialKernelConfiguration >( this->trial_finite_element_space, dofs_vector_in );
      auto dofs_out = MakeReadWriteElementVectorView< TestKernelConfiguration >( this->test_finite_element_space, dofs_vector_out );
