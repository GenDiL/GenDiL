...
GENDIL_HOST_DEVICE
void ApplyMappingTranspose( const Real & inv_J, Real (& Gu)[Dim] )
{
...
template < size_t offset, size_t Dim >
GENDIL_HOST_DEVICE
void ApplyMappingTranspose( const Real (& inv_J)[1][1], Real (& Gu)[Dim] )
{
...
template < size_t offset, size_t Dim >
GENDIL_HOST_DEVICE
void ApplyMappingTranspose( const Real (& inv_J)[2][2], Real (& Gu)[Dim] )
{
...
template < size_t offset, size_t Dim >
GENDIL_HOST_DEVICE
void ApplyMappingTranspose( const Real (& inv_J)[3][3], Real (& Gu)[Dim] )
{
...
template < size_t Dim >
GENDIL_HOST_DEVICE
void ApplyMappingTranspose( const Real (& inv_J)[Dim][Dim], Real (& Gu)[Dim] )
{
...
template < size_t offset, size_t Dim >
GENDIL_HOST_DEVICE
void ApplyMappingTranspose( const std::array< std::array< Real, 1 >, 1 > & inv_J, Real (& Gu)[Dim] )
{
   Gu[offset] = inv_J[0][0] * Gu[offset];
}
...
template < size_t offset, size_t Dim >
GENDIL_HOST_DEVICE
void ApplyMappingTranspose( const std::array< std::array< Real, 2 >, 2 > & inv_J, Real (& Gu)[Dim] )
{
   const Real x = inv_J[0][0] * Gu[offset+0] + inv_J[1][0] * Gu[offset+1];
   const Real y = inv_J[0][1] * Gu[offset+0] + inv_J[1][1] * Gu[offset+1];
   Gu[offset+0] = x;
...
template < size_t offset, size_t Dim >
GENDIL_HOST_DEVICE
void ApplyMappingTranspose( const std::array< std::array< Real, 3 >, 3 > & inv_J, Real (& Gu)[Dim] )
{
   const Real x = inv_J[0][0] * Gu[offset+0] + inv_J[1][0] * Gu[offset+1] + inv_J[2][0] * Gu[offset+2];
   const Real y = inv_J[0][1] * Gu[offset+0] + inv_J[1][1] * Gu[offset+1] + inv_J[2][1] * Gu[offset+2];
   const Real z = inv_J[0][2] * Gu[offset+0] + inv_J[1][2] * Gu[offset+1] + inv_J[2][2] * Gu[offset+2];
...
template < size_t Dim >
GENDIL_HOST_DEVICE
void ApplyMappingTranspose( const std::array< std::array< Real, Dim >, Dim > & inv_J, Real (& Gu)[Dim] )
{
   ApplyMappingTranspose<0>( inv_J, Gu );
}
