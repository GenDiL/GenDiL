...
void test_poisson_2D( const Integer n )
{
    ...
    auto err_L2 = L2Error<KernelPolicy>( fe_space, int_rules, Manufactured<2>::u_exact, x );
...
void test_range()
{
    ...
    while( true )
    {
        ...
        test_poisson_2D<order,num_quad_1d>( n );
...
int main()
{
    ...
    cout << "\n2D Poisson Convergence Study\n"
         << "  Manufactured: ∏ sin(π x_i)\n\n"
         << "  \\begin{tikzpicture}[scale=0.9]\n"
         << "    \\begin{axis}[\n"
         << "       title={L2‐Error vs DoFs (2D Poisson)},\n"
