...
void test_range()
{
   ...
   {
      test_advection_4D< order, num_quad_1d >( n[0], n[1], n[2], n[3] );
      n[i] *= 2;
      i = (i+1)%dim;
      num_dofs *= 2;
   }
