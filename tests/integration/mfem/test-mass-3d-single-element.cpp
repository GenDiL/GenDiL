...
//    PeriodicCartesian3DMesh mesh( h, h, h, nx, ny, nz, { 0.0, 0.0, 0.0 } );
   ...
   auto mass_operator_1d = MakeMassFiniteElementOperator< ThreadingPolicy1d >( fe_space, int_rules, sigma );
   ...
   // dofs_in = 1.0;
   std::cout << "\nMass 1D" << std::endl;
   mass_operator_1d.Mult( dofs_in, dofs_out_mf_1d );
   GENDIL_DEVICE_SYNC;
   std::cout << "\nMass 2D" << std::endl;
   mass_operator_2d.Mult( dofs_in, dofs_out_mf_2d );
   GENDIL_DEVICE_SYNC;
   std::cout << "\nMass 3D" << std::endl;
   mass_operator_3d.Mult( dofs_in, dofs_out_mf_3d );
   GENDIL_DEVICE_SYNC;
